...
<div class="container mt-3">
  ...
  <form method="POST" action="<?= base_url('recursos/registrar') ?>">
    <div class="card">
      <div class="card-body row g-3">
        ...
        <div class="col-md-6">
          ...
          <select class="form-select" name="idSubcategoria" id="idSubcategoria" required>
            ...
            <?php foreach($subcategorias as $sub): ?>
              <option value="<?= $sub['idsubcategoria'] ?>"><?= $sub['nombre'] ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        ...
        <div class="col-md-6">
          ...
          <select class="form-select" name="idEditorial" id="idEditorial" required>
            ...
            <?php foreach($editoriales as $edi): ?>
              <option value="<?= $edi['ideditorial'] ?>"><?= $edi['empresa'] ?></option>
            <?php endforeach; ?>
          </select>
        </div>
        ...
        <div class="col-md-4">
          ...
          <input type="number" class="form-control" name="apublicacion" id="apublicacion" required>
        </div>
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="rutaportada" id="rutaportada">
        </div>

        <div class="col-md-6">
          <label for="rutarecurso" class="form-label">Ruta Recurso</label>
          <input type="text" class="form-control" name="rutarecurso" id="rutarecurso">
        </div>
